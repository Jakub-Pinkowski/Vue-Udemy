<template>
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control" :class="{ invalid: !rate.isValid }">
            <label for="firstname">Hourly Rate</label>
        ...
        <div class="form-control" :class="{ invalid: !areas.isValid }">
            ...
            <div>
                <input type="checkbox" id="frontend" value="frontend" v-model="areas.value" @blur="clearValidity('area')">
                <label for="frontend">Frontend Development</label>
            </div>
            <div>
                <input type="checkbox" id="backend" value="backend" v-model="areas.value" @blur="clearValidity('area')">
                <label for="backend">Backend Development</label>
            </div>
            <div>
                <input type="checkbox" id="career" value="career" v-model="areas.value" @blur="clearValidity('area')">
